...
namespace
{
    const char* applicationFolderName = "RVCTuner";
    const char* modelsFolderName = "models";
    const char* environmentVariableName = "RVCTUNER_MODEL_PATH";
}
...
void VoiceModelLibrary::buildSearchPaths()
{
   ...
   #if defined (RVCTUNER_DEVELOPMENT_MODEL_PATH)
    searchPaths.push_back (juce::File { RVCTUNER_DEVELOPMENT_MODEL_PATH });
   #endif
